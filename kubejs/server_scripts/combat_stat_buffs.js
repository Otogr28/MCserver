...
//   * block_factorys_bosses:yeti     (Skor, The Yeti)                      HP x2.5, DMG x2
//   * block_factorys_bosses:kraken   (Nerakyss, The Kraken — main body)    HP x2.5, DMG x2
//
...
(function () {
    ...
    const BUFFS = {
        ...
        'block_factorys_bosses:yeti':   { hp: 2.5, dmg: 2.0 },
        'block_factorys_bosses:kraken': { hp: 2.5, dmg: 2.0 },
    }
